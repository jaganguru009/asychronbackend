  ...
  userModel.findById(id, (err, result) => {
    ...
    if (err) {
      ...
      if (result != null) {
        ...
        result.workPhone = user.workPhone || result.workPhone;
        result.email = user.email || result.email;
        result.Linkedin = user.Linkedin || result.Linkedin;
        result.skypeId = user.skypeId || result.skypeId;
        result.permanantAdd = user.permanantAdd || result.permanantAdd;
        result.currentAdd = user.currentAdd || result.currentAdd;
        ...
        result.isLoggedIn =
          user.isLoggedIn != undefined ? user.isLoggedIn : result.isLoggedIn;
