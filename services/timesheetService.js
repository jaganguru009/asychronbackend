  ...
  timesheetModel.findById(id, (err, result) => {
    if (err) {
      ...
      if (result != null) {
        ...
        result.totalHours = Timesheet.totalHours || result.totalHours;
        result.creationDate = Timesheet.creationDate || result.creationDate;
        result.project = Timesheet.project || result.project;
        result.department = Timesheet.department || result.department;
        result.module = Timesheet.module || result.module;
        ...
        result.submittedOn = Timesheet.submittedOn || result.submittedOn;
